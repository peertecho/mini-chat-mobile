...
// '@minichat/writers' collection key
...
// '@minichat/writers' value encoding
const collection0_enc = getEncoding('@minichat/writers/hyperdb#0')

// '@minichat/writers' reconstruction function
...
// '@minichat/writers' key reconstruction function
...
// '@minichat/invites' collection key
...
// '@minichat/invites' value encoding
const collection1_enc = getEncoding('@minichat/invites/hyperdb#1')

// '@minichat/invites' reconstruction function
...
// '@minichat/invites' key reconstruction function
...
// '@minichat/users' value encoding
const collection2_enc = getEncoding('@minichat/users/hyperdb#2')

// '@minichat/users' reconstruction function
...
// '@minichat/users' key reconstruction function
...
// '@minichat/messages' collection key
...
// '@minichat/messages' value encoding
const collection3_enc = getEncoding('@minichat/messages/hyperdb#3')

// '@minichat/messages' reconstruction function
...
// '@minichat/messages' key reconstruction function
...
function resolveCollection (name) {
  switch (name) {
    case '@minichat/writers': return collection0
    case '@minichat/invites': return collection1
    case '@minichat/users': return collection2
    case '@minichat/messages': return collection3
    default: return null
  }
}
